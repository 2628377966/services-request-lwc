...
import { setCSSProperties, getIconURL } from 'c/appUtil';
import Toast from 'lightning/toast';
import getPartnerConfig from '@salesforce/apex/OJInitiatorCtrl.getPartnerConfigByAccountId';


export default class AppPartnerServiceOptions extends LightningElement {
    @api payload;
    ...
    handleEftposMultiMerchantClick() {
        ...
        // Update payload and navigate to appSignupVerifyAccount
