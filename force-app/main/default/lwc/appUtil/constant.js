...
const getSignupSteps = () => {
    return [
        { screenName: 'signup options', componentName: 'appSignupOptions' },
        { screenName: 'validate existing account', componentName: 'appSignupVerifyAccount'},
        { screenName: 'redirect to kyc csa', componentName: 'appSignupShowKYCCSA' }
    ];
};
